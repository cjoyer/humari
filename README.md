...
> [!NOTE]
> Цей проєкт задумувався як бот для одного сервера. Тобто, він не зможе правильно функціонувати на декількох серверах.

### Що вміє ця шняга?
- ✨ Привітати нових юзерів (`on_member_join`), створювати приватні ГС канали (`on_voice_state_update`)
- 🛡️ Модерація: `ban`, `kick`, `clear`
- ⚠️ Ауторепорти помилок із `on_slash_command_error`
___
